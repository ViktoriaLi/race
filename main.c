...
/*   Updated: 2017/12/03 21:43:21 by vlikhotk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_base	**data_base(t_base **base, unsigned char *key,
	unsigned char *value)
{
	int		i;
	int		lenk;
	...
	lenk = ft_strlen(key) + 1;
	lenv = ft_strlen(value) + 1;
